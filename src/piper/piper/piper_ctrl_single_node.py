...
class PiperRosNode(Node):
    ...
    def joint_callback(self, joint_data):
        ...
        self.get_logger().info(f"joint_1: {joint_data.position[0]}")
        self.get_logger().info(f"joint_2: {joint_data.position[1]}")
        self.get_logger().info(f"joint_3: {joint_data.position[2]}")
        self.get_logger().info(f"joint_4: {joint_data.position[3]}")
        self.get_logger().info(f"joint_5: {joint_data.position[4]}")
        self.get_logger().info(f"joint_6: {joint_data.position[5]}")
        self.get_logger().info(f"gripper_joint: {joint_data.position[6]}")
